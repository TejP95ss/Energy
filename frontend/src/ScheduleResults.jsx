    ...
    <div className="results">
      ...
      {hasSavings && (
        <div className="savings-banner">
          ⚡ You save <strong>${result.total_savings_dollars.toFixed(3)}</strong> by running
          at optimized times vs. starting each device as early as possible.
        </div>
      )}
          ...
          return (
            <div key={dev.name} className="device-result-card">
              ...
              <div className="dr-stats">
                ...
                {saved > 0 && (
                  <span className="dr-was">
                    was {cents(dev.unoptimized_cost_cents)}
                  </span>
                )}
              </div>
            </div>
